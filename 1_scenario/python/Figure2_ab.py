...
linefitmin = 0
filtered_X_CT = [i for i, j in zip(x,nCT_ln) if j < 0 and i>=linefitmin ] # do filter n>0 and Dp>=140nm
filtered_nCT = [j for i, j in zip(x,nCT_ln) if j < 0 and i>=linefitmin]

filtered_X_CT10_40nm = [i for i, j in zip(x,nCT_ln10_40nm) if j < 0 ] # do filter n>0 and Dp>=140nm
filtered_nCT10_40nm = [j for i, j in zip(x,nCT_ln10_40nm) if j < 0 ]

filtered_X_CT40_70nm = [i for i, j in zip(x,nCT_ln40_70nm) if j < 0 ] # do filter n>0 and Dp>=140nm
filtered_nCT40_70nm = [j for i, j in zip(x,nCT_ln40_70nm) if j < 0 ]

filtered_X_CT70_100nm = [i for i, j in zip(x,nCT_ln70_100nm) if j < 0 ] # do filter n>0 and Dp>=140nm
filtered_nCT70_100nm = [j for i, j in zip(x,nCT_ln70_100nm) if j < 0 ]

filtered_X_CT100_130nm = [i for i, j in zip(x,nCT_ln100_130nm) if j < 0 ] # do filter n>0 and Dp>=140nm
filtered_nCT100_130nm = [j for i, j in zip(x,nCT_ln100_130nm) if j < 0 ]
