...
ax.text(400,-3,'k = '+str(abs(round(k,3))),fontsize=10,horizontalalignment='left', verticalalignment='center')
ax.text(400,-4.5,'$\mathrm{R^2}$ = '+str(abs(round(R_2,3))),fontsize=10,horizontalalignment='left', verticalalignment='center')
ax.set_xlim([0,600])
ax.set_ylim([-14,0])
...
ax.tick_params(top=True, bottom=True, left=True, right=True)
#ax.autoscale(tight=True)
plt.legend(loc='center right',fontsize=8,frameon=False)#,bbox_to_anchor = (1,0.5))
